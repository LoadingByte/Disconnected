 ...
 */
public class LaunchInteractiveProcessProgramCommand extends EventBase {

    private final SBPWorldProcessUserDetails worldProcessUserDetails;
    private final String                     programName;

    /**
     * Creates a new launch interactive process program command.
     *
     ...
     */
    public LaunchInteractiveProcessProgramCommand(SBPWorldProcessUserDetails worldProcessUserDetails, String programName) {
