 ...
 */
public class LaunchTaskProcessCommand extends EventBase {
     ...
     */
    public LaunchTaskProcessCommand(SBPWorldProcessUserDetails worldProcessUserDetails, String programName) {
