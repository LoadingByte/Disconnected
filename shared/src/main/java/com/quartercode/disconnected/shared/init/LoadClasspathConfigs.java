...
@InitializerSettings (groups = { "loadConfigs", "initializeResources" }, dependencies = { "registerServices", "addConfigCommands" })
public class LoadClasspathConfigs implements Initializer {
