...
public class FileManagerProgramChangeDirTest extends AbstractProgramTest {
    ...
    public void testWithDirectory() {
        ...
        // /test1/test2
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test1/test2", invoked), RESPONSE_PREDICATE);
    ...
    public void testWithDirectoryMultipleTimes() {
        ...
        // /test1
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test1", invoked1), RESPONSE_PREDICATE);
        sendChangeDirCommand(ROOT + "/test1");

        // /test1/test2
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test1/test2", invoked2), RESPONSE_PREDICATE);
        sendChangeDirCommand("test2");

        // /test1/test3
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test1/test3", invoked3), RESPONSE_PREDICATE);
        sendChangeDirCommand("../test3");

        // /test4
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test4", invoked4), RESPONSE_PREDICATE);
    ...
    public void testWithAbsoluteRoot() {
        ...
        // /
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler("/", invoked), RESPONSE_PREDICATE);
    ...
    public void testWithRootFile() {
        ...
        // /system
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler("/" + CommonFiles.SYSTEM_MOUNTPOINT, invoked), RESPONSE_PREDICATE);
    ...
    public void testWithInvalidDirectory() {
        ...
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(null, invoked), RESPONSE_PREDICATE);
    ...
    public void testWithSuddenlyInvalidDirectory() {
        ...
        // /test1/test2/test5
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test1/test2/test5", invoked1), RESPONSE_PREDICATE);
        ...
        bridge.getModule(StandardHandlerModule.class).addHandler(new FMPClientUpdateViewCommandTestHandler(ROOT + "/test1", invoked2), RESPONSE_PREDICATE);
    ...
    private class FMPClientUpdateViewCommandTestHandler implements EventHandler<FMPClientUpdateViewCommand> {

        private final String         expectedCurrentDir;
        private final MutableBoolean invoked;

        private FMPClientUpdateViewCommandTestHandler(String expectedCurrentDir, MutableBoolean invoked) {
