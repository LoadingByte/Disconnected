...
public class ProgramUtils {
    ...
    public static WorldProcessId getProcessId(Process<?> process) {
        ...
        String computerId = process.invoke(Process.GET_OS).getParent().getId();
     ...
     */
    @NonPersistent
    private static class RemoveEventHandlerOnStopPSListener extends WorldFeatureHolder implements ProcStateListener {
