...
public class RegisterProfileSerializationService implements Initializer {

    @Override
    public void initialize() {

        ServiceRegistry.register(ProfileSerializationService.class, new DefaultProfileSerializationService());
    }
