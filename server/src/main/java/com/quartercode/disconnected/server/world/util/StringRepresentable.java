...
public interface StringRepresentable extends CFeatureHolder {
     ...
     */
    public static final FunctionDefinition<String> TO_STRING   = factory(FunctionDefinitionFactory.class).create("toString", new Class[0]);
     ...
     * </table>
     */
    public static final FunctionDefinition<Void>   FROM_STRING = factory(FunctionDefinitionFactory.class).create("fromString", new Class[] { String.class });
