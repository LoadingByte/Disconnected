...
public class RemoveWorldContextPathEntryCommand implements ConfigCommandParser {

    private static final Logger       LOGGER = LoggerFactory.getLogger(RemoveWorldContextPathEntryCommand.class);
