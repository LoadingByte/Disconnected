...
public class MainboardSlotTest {
    ...
    public void setUp() throws Exception {
        ...
        content = new CPU(null, null, null, 0, 0);
    ...
    public void testAccept() {
        ...
        Assert.assertTrue("Accept CPU", mainboradSlot.accept(new CPU(null, null, null, 0, 0)));
    }

    @Test
    public void testNotAccept() {

        Assert.assertFalse("Accept RAM (invalid)", mainboradSlot.accept(new RAM(null, null, null, 0, 0)));
    }
    ...
    public void testSetContent() {
        ...
        CPU newContent = new CPU(null, null, null, 0, 0);
