 ...
 * The class should be inherited for each desktop program in order to make the {@link #create(GraphicsState)} method type-safe.<br>
 * <br>
...
public abstract class DesktopProgramDescriptor {
     ...
     */
    public abstract DesktopProgramWindow create(GraphicsState state);
